...
export class ProfileOverviewComponent extends BaseProfileComponent {
    ...
    setupNotificationMessage() {
        ...
        if (!this.model || !this.model.isOwnProfile || !this.model.projects.pager || !this.model.reviews.pager || this.model.projects.pager.totalResults >= 2 && this.model.biography && this.model.reviews.pager.totalResults >= 1) {
