...
import { ReportDialogService } from  './dialog.service'
...
@Component({
    selector: 'ij-report-problem-dialog',
    styleUrls: ['styles.less'],
    templateUrl: 'dialog.component.html'
})

export class ReportDialogComponent  extends BaseDialogComponent<ReportProfileDialog> implements OnDestroy{
    ...
    constructor(
        el: ElementRef,
        private dialogSvc: ReportDialogService, 
