...
import { HireAddExpenseService } from './hire-addExpanseRequest.service';
...
@Component({
  selector: 'ij-hire-addExpanseRequest',
  templateUrl: 'hire-addExpanseRequest.component.html',
  styleUrls: ['../../../payment-screen/styles/hire.less',
              'styles.less'
              ],
  providers: [HireAddExpenseService, DatePipe]
})
export class HireAddExpanseComponent extends BaseDialogComponent<HireProfileDialog>  implements OnDestroy { 
  ...
  constructor(
    ...
    private hireExpensiveSvc: HireAddExpenseService,
